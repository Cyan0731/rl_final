...
from scripts.modeling_audioldm2 import AudioLDM2ProjectionModel, AudioLDM2UNet2DConditionModel
...
class AudioLDM2Pipeline(DiffusionPipeline,TextualInversionLoaderMixin):
    ...
    def encode_prompt(
        ...
        # print("tokenizers",len(tokenizers))
        # print("text_encoders",len(text_encoders))
        if prompt_embeds is None:
            ...
            # prompt_embeds_list[0] = prompt_embeds_list[0].float()
            # print(len(prompt_embeds_list))
            # print(prompt_embeds_list[0].dtype)
            # print(prompt_embeds_list[1].dtype)
            # print(attention_mask_list[0].dtype)
            # print(attention_mask_list[1].dtype)

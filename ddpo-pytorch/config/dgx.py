...
def compressibility():
    ...
    config.pretrained.model = "/data/fundwotsai/RL_final/ddpo-pytorch/audioldm2-music"
...
# use this config in testing pipeline
def audio_test():
    config = compressibility()
    config.num_epochs = 200
    config.reward_fn = "clap_score"
    ...
    config.prompt_fn_kwargs = {
        "nouns_file": "emotions.txt",
        "activities_file": "instruments.txt",
    }
    return config
